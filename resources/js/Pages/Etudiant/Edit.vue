            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-4">
                    <div class="card mr-2 ml-4 mb-3 mt-4 shadow-sm">
                        ...
                        <div class="card-body mt-4">
                            ...
                            <p class="card-text"><strong>Date de naissance: </strong>{{ this.etudiant[0].dateDeNaissance
                                }}</p>
                            <p class="card-text"><strong>Genre: </strong>{{ this.etudiant[0].genre }}</p>
                            <p class="card-text">
                ...
                <div class="col-md-8 mt-5">
                    <form @submit.prevent="handleSubmit" class="mb-5">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <select class="custom-select" id="genre" name="genre" v-model="form.genre">
