  ...
  return _c("div", [
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row" }, [
        _c(
          "div",
          { staticClass: "col-md-10 ml-5" },
          _vm._l(_vm.user, function(item) {
            return _c("div", { key: item.id, staticClass: "card m-5" }, [
              ...
              _vm._v(" "),
              _c("h1", [_vm._v(_vm._s(item.nom) + " " + _vm._s(item.prenom))]),
              _vm._v(" "),
              _c("strong", [_vm._v("Adresse")]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(item.adresse))]),
              _vm._v(" "),
              _c("strong", [_vm._v("Telephone")]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(item.telephone))]),
              _vm._v(" "),
              _c("strong", [_vm._v("Competences")]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(item.competences))]),
              _vm._v(" "),
